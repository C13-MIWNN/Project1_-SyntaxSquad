...
//
//        AmountOfIngredient gramsSausages = makeAmountOfIngredient(1.00, sausages);
//        AmountOfIngredient gramsCurry = makeAmountOfIngredient(1.00, curry);
...
//                              AmountOfIngredient amountOfIngredient, Tag tag) {
//        Recipe recipe = new Recipe();
//        recipe.setRecipeName(recipeName);
//        recipe.setInstructions(instructions);
//
//        Set<AmountOfIngredient> amountOfIngredientSet = new HashSet<>();
//        amountOfIngredientSet.add(amountOfIngredient);
//        recipe.setAmountOfIngredients(amountOfIngredientSet);
//
