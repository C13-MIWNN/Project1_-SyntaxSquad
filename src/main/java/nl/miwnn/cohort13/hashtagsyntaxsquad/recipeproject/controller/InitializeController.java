...
public class InitializeController {
    ...
    private String initializeDB() {
        ...
        Ingredient potatoes = makeIngredient("Potatoes", "piece");
        Ingredient curry = makeIngredient("Curry", "grams");
        Ingredient sausages = makeIngredient("Sausages", "grams");
        Ingredient onions = makeIngredient("Onions", "piece");
    ...
    private Ingredient makeIngredient(String name, String unitOfMeasurement) {
